...
class OnPolicyAlgorithm(BaseAlgorithm):
    ...
    def learn(
        ...
        while self.num_timesteps < total_timesteps:
            continue_training = self.collect_rollouts(self.env, callback, self.data_storage, self.rollout_buffer, n_rollout_steps=self.n_steps, )
            if dynamics_model is not None:
                update_loss = dynamics_model.update(self.rollout_buffer)
            ...
            if log_interval is not None and iteration % log_interval == 0:
                ...
                if update_loss != 0:
                    self.logger.record("dynamic_model/loss", update_loss, exclude="tensorboard")
